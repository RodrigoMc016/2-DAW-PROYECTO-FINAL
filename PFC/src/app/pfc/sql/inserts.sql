...
INSERT INTO products (category_id, name, description, price_real, price_points, image_url) VALUES
    ((SELECT id FROM categories WHERE name = 'BURGERS'), 
     ...
     8.00, 80, 'assets/images/burgers/brie_caramelizada.jpg'),
    ...
    ((SELECT id FROM categories WHERE name = 'BURGERS'), 
     ...
     9.00, 90, 'assets/images/burgers/jamon_serrano.jpg'),
    ...
    ((SELECT id FROM categories WHERE name = 'BURGERS'), 
     ...
     9.50, 95, 'assets/images/burgers/champinones_trufa.jpg'),
    ...
    ((SELECT id FROM categories WHERE name = 'BURGERS'), 
     ...
     8.50, 85, 'assets/images/burgers/mediterranea_cabra.jpg'),
    ...
    ((SELECT id FROM categories WHERE name = 'BURGERS'), 
     ...
     7.0, 70, 'assets/images/burgers/bbq_bacon.jpg'),
...
INSERT INTO products (category_id, name, description, price_real, price_points, image_url) VALUES
    ((SELECT id FROM categories WHERE name = 'VEGANOS'), 
     ...
     8.00, 80, 'assets/images/veggies/garbanzos_espinacas.jpg'),
    ...
    ((SELECT id FROM categories WHERE name = 'VEGANOS'), 
     ...
     7.00, 70, 'assets/images/veggies/quinoa_kale.jpg'),
    ...
    ((SELECT id FROM categories WHERE name = 'VEGANOS'), 
     ...
     7.50, 75, 'assets/images/veggies/berenjena_hummus.jpg');
...
INSERT INTO products (category_id, name, description, price_real, price_points, image_url) VALUES
	...
	4.50, 45, 'assets/images/postres/brownie_helado.jpg'),

    ((SELECT id FROM categories WHERE name = 'POSTRES'), 
     'Cheesecake de Fresa', 
     'Suave y cremoso cheesecake con una capa de fresas frescas en su punto.', 
     4.50, 45, 'assets/images/postres/cheesecake_fresa.jpg'),
    ...
    ((SELECT id FROM categories WHERE name = 'POSTRES'), 
     ...
     5.00, 50, 'assets/images/postres/tarta_manzana.jpg');